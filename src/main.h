...
T3_WIDGET_API connection_t connect_resize(std::function<void(int, int)> func);
...
*/
T3_WIDGET_API connection_t connect_update_notification(std::function<void()> func);
...
*/
T3_WIDGET_API connection_t connect_on_init(std::function<void(bool)> func);
...
*/
T3_WIDGET_API connection_t connect_terminal_settings_changed(std::function<void()> func);

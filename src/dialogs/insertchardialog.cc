	...
	dialog_t(INSERT_CHAR_DIALOG_HEIGHT, INSERT_CHAR_DIALOG_WIDTH, "Insert Character")
{
	...
	cancel_button->connect_move_focus_left(signals::mem_fun(this, &insert_char_dialog_t::focus_previous));
	...
	cancel_button->connect_move_focus_up(signals::mem_fun(this, &insert_char_dialog_t::focus_previous));
	cancel_button->connect_move_focus_up(signals::mem_fun(this, &insert_char_dialog_t::focus_previous));

...
input_selection_dialog_t::input_selection_dialog_t(int height, int width, text_buffer_t *_text)
  ...
  impl->enable_simulate_box->connect_toggled(
      signals::mem_fun(this, &input_selection_dialog_t::check_state));
  impl->enable_simulate_box->connect_activate(
      signals::mem_fun(this, &input_selection_dialog_t::ok_activated));
  impl->enable_simulate_box->connect_move_focus_up(
      signals::mem_fun(this, &input_selection_dialog_t::focus_previous));
  impl->enable_simulate_box->connect_move_focus_down(
      signals::mem_fun(this, &input_selection_dialog_t::focus_next));

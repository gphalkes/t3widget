...
class T3_WIDGET_API button_t : public widget_t, public focus_widget_t {
	private:
		...
		cleanup_ptr<smart_label_text_t> text;
		...
		bool is_default,
			has_focus; /**< Boolean indicating whether this button has the input focus. */

	public:
		/** Create a button_t.
		    @param _text The text to show on the button.
		    @param _is_default Boolean indicating whether this button should be drawn as the default button.
	...
	/** @fn sigc::connection connect_activate(const sigc::slot<void> &_slot)

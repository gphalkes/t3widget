...
void edit_window_t::init(bool _init) {
  if (_init) {
    ...
    right_click_menu->insert_item(_("Cu_t"), "", ACTION_CUT);
    right_click_menu->insert_item(_("_Copy"), "", ACTION_COPY);
    right_click_menu->insert_item(_("_Paste"), "", ACTION_PASTE);
    right_click_menu->insert_item(_("Paste _Selection"), "", ACTION_PASTE_SELECTION);
  } else {
    delete goto_dialog;
    goto_dialog = nullptr;

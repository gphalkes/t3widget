...
void set_color_mode(bool on) {
	...
	if (on) {
		...
		attributes.selection_cursor = T3_ATTR_FG_WHITE | T3_ATTR_BG_CYAN;
		attributes.selection_cursor2 = T3_ATTR_FG_WHITE | T3_ATTR_BG_GREEN;
		attributes.bad_draw = T3_ATTR_FG_RED;
		attributes.text_cursor = T3_ATTR_FG_WHITE | T3_ATTR_BG_CYAN;
